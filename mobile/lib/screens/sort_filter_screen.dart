...
class _SortFilterScreenState extends State<SortFilterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Sort & Filter', style: TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white)),
        leading: IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Sort By', style: TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.bold, fontSize: 15, color: Color(0xFF7C3AED))),
            SizedBox(height: 8),
            Wrap(
              spacing: 12,
              children: [
            ...
            Row(
              ...
              children: [
                Text('Show Only Available', style: TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.w600, fontSize: 14)),
                Switch(
                  value: onlyAvailable,
            ...
            SizedBox(height: 28),
            Text('Price Range', style: TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.bold, fontSize: 15, color: Color(0xFF7C3AED))),
            SizedBox(height: 8),
            RangeSlider(
              values: priceRange,
              ...
              child: ElevatedButton(
                ...
                child: Ink(
                  ...
                  child: Container(
                    ...
                    child: Text('Apply', style: TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white)),
                  ),
                ),
              ),
            ),
  ...
  Widget _sortChip(String label) {
    ...
    return ChoiceChip(
      label: Text(label, style: TextStyle(fontFamily: 'Lato', color: selected ? Colors.white : Color(0xFF7C3AED), fontWeight: FontWeight.bold)),
      selected: selected,
  ...
  Widget _dayChip(String d) {
    ...
    return FilterChip(
      label: Text(d, style: TextStyle(fontFamily: 'Lato', color: selected ? Colors.white : Color(0xFF7C3AED), fontWeight: FontWeight.bold)),
      selected: selected,
      selectedColor: Color(0xFF7C3AED),
      backgroundColor: Color(0xFFF6F3FF),
